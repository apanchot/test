...
@app.callback(
    [
        ...
        dash.dependencies.Output("scattergeo", "figure")    ],
    [
        dash.dependencies.Input("button", 'n_clicks')
    ],
    [
        dash.dependencies.State("city_drop", "value"),
        dash.dependencies.State("indicator", "value"),   ]
)
...
@app.callback(
    [
        dash.dependencies.Output("indic_1", "children"),
        dash.dependencies.Output("indic_2", "children"),
        dash.dependencies.Output("indic_3", "children"),
    ],
